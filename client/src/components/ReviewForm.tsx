    ...
    <>
      ...
      <div className='flex flex-col'>
        <Field
          ...
          className='mt-6 resize-none rounded-md bg-gray-50 p-3 outline-none dark:bg-neutral-800 dark:text-gray-200 dark:caret-white'
        />
        ...
        <Field
          ...
          id='rating'
          name='rating'
          className='mb-4 w-fit rounded-md bg-gray-50 p-2 dark:bg-neutral-800 dark:text-gray-200'
        />
        <button
          type='submit'
          className='mt-4 w-fit rounded-md bg-red-500 px-3 py-2 text-white transition duration-300 hover:bg-red-600'
        >
          Submit
        </button>
      </div>
