  ...
  return (
    <Layout>
      <div className='mx-4 mt-28 flex flex-col justify-center text-center align-middle sm:mt-32'>
        ...
        <p className='mx-10 text-xl leading-loose text-gray-700 sm:mx-28 lg:mx-60'>
          {' '}
        ...
        <div className='m-2 flex justify-center'>
          <a href='https://www.github.com/terror/mcgill.gg'>
            <AiOutlineGithub
              className='mx-2 text-gray-500 transition-colors duration-300 hover:text-gray-700'
              size={40}
            ></AiOutlineGithub>
          </a>
          <a href='mailto:'>
