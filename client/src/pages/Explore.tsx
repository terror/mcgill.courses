                ...
                {courses ? (
                  <Fragment>
                    <SearchBar
                      ...
                      inputStyle='block rounded-lg w-full bg-slate-200 p-3 pr-5 pl-12 text-sm text-black outline-none dark:border-neutral-50 dark:bg-neutral-800 dark:text-gray-200 dark:placeholder:text-neutral-500'
                      outerIconStyle='pl-5'
