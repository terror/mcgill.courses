...
mod tests {
  ...
  #[test]
  fn extract_catalog_course_listings_2025_2026() {
    assert_eq!(
      CatalogExtractor
        .extract_course_listings(&get_content(
          "catalog_course_listings_2025_2026.html"
        ))
        .unwrap()
        .unwrap(),
      vec![
        CourseListing {
          url: "https://coursecatalogue.mcgill.ca/courses/ansc-565/".into(),
          ..Default::default()
        },
        CourseListing {
          url: "https://coursecatalogue.mcgill.ca/courses/edsl-668/".into(),
          ..Default::default()
        },
        CourseListing {
          url: "https://coursecatalogue.mcgill.ca/courses/nutr-613/".into(),
          ..Default::default()
        },
        CourseListing {
          url: "https://coursecatalogue.mcgill.ca/courses/swrk-690/".into(),
          ..Default::default()
        },
        CourseListing {
          url: "https://coursecatalogue.mcgill.ca/courses/edpe-609/".into(),
          ..Default::default()
        },
        CourseListing {
          url: "https://coursecatalogue.mcgill.ca/courses/epib-601/".into(),
          ..Default::default()
        },
        CourseListing {
          url: "https://coursecatalogue.mcgill.ca/courses/aebi-210/".into(),
          ..Default::default()
        },
        CourseListing {
          url: "https://coursecatalogue.mcgill.ca/courses/nutr-612/".into(),
          ..Default::default()
        },
        CourseListing {
          url: "https://coursecatalogue.mcgill.ca/courses/bioc-311/".into(),
          ..Default::default()
        },
        CourseListing {
          url: "https://coursecatalogue.mcgill.ca/courses/east-305/".into(),
          ..Default::default()
        },
      ]
    );
